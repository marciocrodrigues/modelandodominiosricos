...
namespace NerdStore.Vendas.Application.Commands
{
    public class PedidoCommandHandler :
        ...
        IRequestHandler<CalcelarProcessamentoPedidoEstornarEstoqueCommand, bool>,
        IRequestHandler<CancelarProcessamentoPedidoCommand, bool>
    {
        ...
        public async Task<bool> Handle(AdicionarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.AdicionarEvento(new PedidoItemAdicionadoEvent(pedido.ClientId,
                                                                        pedido.Id,
                                                                        message.ProdutoId,
        ...
        public async Task<bool> Handle(AtualizarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.AtualizarUnidade(pedidoItem, message.Quantidade);

            pedido.AdicionarEvento(new PedidoAtualizadoEvent(pedido.ClientId, pedido.Id, pedido.ValorTotal));

            pedido.AdicionarEvento(new PedidoProdutoAtualiadoEvent(pedido.ClientId, pedido.Id, message.ProdutoId, message.Quantidade));
        ...
        public async Task<bool> Handle(IniciarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            pedido.AdicionarEvento(new PedidoIniciadoEvent(pedido.Id,
                                                                 pedido.ClientId,
                                                                 pedido.ValorTotal,
                                                                 listaProdutosPedido,
                                                                 message.NomeCartao,
        ...
        public async Task<bool> Handle(CalcelarProcessamentoPedidoEstornarEstoqueCommand message, CancellationToken cancellationToken)
        {
            var pedido = await _pedidoRepository.ObterPorId(message.PedidoId);
            ...
            var itensList = new List<Item>();
            pedido.PedidoItems.ForEach(i => itensList.Add(new Item { Id = i.PedidoId, Quantidade = i.Quantidade }));
            var listaProdutosPedido = new ListaProdutosPedido { PedidoId = pedido.Id, Itens = itensList };

            pedido.AdicionarEvento(new PedidoProcessamentoCanceladoEvent(pedido.Id, pedido.ClientId, listaProdutosPedido));
