...
namespace NerdStore.Vendas.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        {
            var pedido = await _context.Pedidos.FirstOrDefaultAsync(p => p.ClientId == clienteId && p.PedidoStatus == PedidoStatus.Rascunho);
            if (pedido == null)
                return null;

            // Já popula os dados de pedidoItems se tiver cadastrado
