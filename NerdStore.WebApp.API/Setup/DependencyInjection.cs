...
namespace NerdStore.WebApp.API.Setup
{
    public static class DependencyInjection
    {
        public static void RegisterServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IRequestHandler<CalcelarProcessamentoPedidoEstornarEstoqueCommand, bool>, PedidoCommandHandler>();
            ...
            services.AddScoped<IPagamentoCartaoCreditoFacade, IPagamentoCartaoCreditoFacade>();
